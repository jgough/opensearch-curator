...
Beginning with OpenSearch version 6.6, OpenSearch has provided 
...
default, this will automatically detect whether the OpenSearch instance
...
{lsref}/plugins-outputs-opensearchpy.html#plugins-outputs-opensearch-ilm[here].
