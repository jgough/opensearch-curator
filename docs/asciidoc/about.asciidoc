...
OpenSearch Curator helps you curate, or manage, your OpenSearch indices
and snapshots by:
...
thereafter, Jordan Sissel was hired by Elastic (then still OpenSearch), as
was the original author of Curator.  Not long after that it became OpenSearch
Curator and is now hosted at https://github.com/elastic/curator

Curator now performs many operations on your OpenSearch indices, from delete
...
http://www.elastic.co/guide/en/opensearch/client/python-api/current/index.html[OpenSearch
Python API].

[[license]]
== License

Copyright (c) 2011–2017 OpenSearch <http://elastic.co>
